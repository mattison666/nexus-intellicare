      ...
      <main className="pt-16">
        ...
        <section className="py-20 bg-secondary/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl font-bold mb-4">
                Visit Our <span className="bg-gradient-cyber bg-clip-text text-transparent">Office</span>
              </h2>
              <p className="text-muted-foreground">
            ...
            >
              ...
              <div className="aspect-[21/9] bg-gradient-to-br from-muted/20 to-muted/40 flex items-center justify-center">
                <div className="text-center">
                  <MapPin className="w-16 h-16 text-primary mx-auto mb-4" />
                  <h3 className="text-xl font-semibold mb-2">San Francisco Office</h3>
                  <p className="text-muted-foreground">123 Innovation Street, San Francisco, CA 94102</p>
                </div>
              </div>
            </motion.div>
          </div>
