...
const CallToAction = () => {
  ...
  return <section className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-10 right-10 w-80 h-80 bg-accent/10 rounded-full blur-3xl animate-float" style={{
        animationDelay: "3s"
      }}></div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        once: true
          ...
          once: true
            ...
            <Link to="/contact">
              <Button variant="glow" size="lg" className="group text-lg px-8 py-6 h-auto">
            ...
            <Link to="/services">
              <Button variant="outline" size="lg" className="group text-lg px-8 py-6 h-auto">
                {t("viewAllProjects")}
          ...
          once: true
            ...
            <p className="text-muted-foreground text-sm">
              ...
              <a href="mailto:info@aicreativegroup.com" className="text-primary hover:text-primary-glow transition-colors font-medium">
                info@aicreativegroup.com
              </a>{" "}
              or call{" "}
              <a href="tel:+15551234567" className="text-primary hover:text-primary-glow transition-colors font-medium">+963948844484</a>
            </p>
          </motion.div>
        </motion.div>
      </div>
